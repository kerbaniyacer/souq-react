    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          {items.map((item) => (
            <div key={item.id} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 flex gap-4">
              {/* Image */}
              <div className="w-24 h-24 bg-gray-50 dark:bg-gray-800 rounded-xl overflow-hidden shrink-0">
                <img
                  src={item.variant?.images?.[0]?.image || '/images/default-product.jpg'}
                  alt=""
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="w-8 h-8 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:border-primary-300 transition-colors"
                    >
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 sticky top-20">
            ...
            <div className="space-y-3 mb-5">
              ...
              <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex justify-between font-arabic font-bold">
                <span>الإجمالي</span>
            ...
            <Link
              to="/products"
              className="block text-center mt-3 text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 font-arabic transition-colors"
            >
              متابعة التسوق
            </Link>
          </div>
