...
import { ArrowRight, Package, Star, Upload, Trash2, Camera, CreditCard, Clock, Store } from 'lucide-react';
...
export default function OrderDetail() {
  ...
  const [activeUploadSeller, setActiveUploadSeller] = useState<number | null>(null);
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="space-y-10">
        ...
        {Object.values(sellerGroups).map((group: any) => {
          ...
          const needsProof = (order.payment_method === 'ccp' || order.payment_method === 'baridimob') && 
                            (!sellerProof || sellerProof.status === 'rejected');
