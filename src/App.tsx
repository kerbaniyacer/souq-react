...
import EmailGallery from '@/pages/admin/emails/EmailGallery';
import WelcomeEmail from '@/pages/admin/emails/WelcomeEmail';
import OtpEmail from '@/pages/admin/emails/OtpEmail';
import PasswordResetEmail from '@/pages/admin/emails/PasswordResetEmail';
import PasswordChangedEmail from '@/pages/admin/emails/PasswordChangedEmail';
import PasswordResetSuccessEmail from '@/pages/admin/emails/PasswordResetSuccessEmail';
import MerchantOrderEmail from '@/pages/admin/emails/MerchantOrderEmail';
import SecurityAlertEmail from '@/pages/admin/emails/SecurityAlertEmail';
import NewsletterEmail from '@/pages/admin/emails/NewsletterEmail';
import SupportEmail from '@/pages/admin/emails/SupportEmail';
        ...
        <Route path="*" element={
          <div className="min-h-screen bg-page-bg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 font-arabic mb-6">الصفحة غير موجودة</p>
