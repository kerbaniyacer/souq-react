            ...
            {product.seller && (
              <div className="flex items-center gap-3 border-r border-gray-200 dark:border-gray-700 pr-4">
                ...
                <p className="text-sm font-arabic flex items-center gap-2 text-gray-500">
                  البائع: <Link to={`/profile/${product.seller.username}`} className="font-bold text-gray-700 dark:text-gray-200 hover:text-primary-600 transition-colors">{product.seller_name || product.seller.username}</Link>
            ...
            <div className="flex justify-between items-center w-full mb-3">
              {(() => {
                ...
                const config: Record<string, { text: string; classes: string }> = {
                  ...
                  low: { text: `على وشك النفاد - بقي ${activeVariant?.stock} فقط`, classes: 'text-red-600 bg-red-50 dark:bg-red-900/20' },
