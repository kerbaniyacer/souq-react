...
export default function VisibilityChangeEmail() {
  const content = useEmailContent('visibility-change');

  return (
    <EmailPreviewWrapper title={content.subject} type="visibility-change">
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ padding: '48px 40px' }}>
                     ...
                     <div style={{ background: '#f0fdf4', borderRadius: 12, padding: 24, margin: '24px 0', border: '1px solid #dcfce7', textAlign: 'center' }}>
                        <p style={{ margin: 0, color: '#166534', fontSize: 16, lineHeight: 1.6 }}>{content.bodyText}</p>
                     </div>
