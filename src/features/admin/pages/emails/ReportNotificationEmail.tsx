...
export default function ReportNotificationEmail() {
  const content = useEmailContent('report-notification');

  return (
    <EmailPreviewWrapper title={content.subject} type="report-notification">
          ...
          <tbody><tr><td align="center">
            <table width="560" cellPadding={0} cellSpacing={0} style={{ background: '#fff', borderRadius: 16, border: '1px solid #E8E2D9', overflow: 'hidden', maxWidth: '100%' }}>
              <tbody>
                {/* Header */}
                <tr>
                  <td align="center" style={{ background: 'linear-gradient(135deg,#c2410c,#9a3412)', padding: '40px' }}>
                ...
                <tr>
                  <td style={{ padding: '20px 40px 40px' }}>
                    ...
                    <div style={{ background: '#fff7ed', borderRadius: 12, padding: '20px', marginBottom: '30px', border: '1px solid #fed7aa' }}>
                      <table width="100%" cellPadding={0} cellSpacing={0} style={{ fontSize: 13, color: '#4b5563' }}>
                        <tbody>
                          <tr>
                            <td style={{ padding: '5px 0', fontWeight: 'bold' }}>المستهدف:</td>
                            <td>منتج: غسالة سامسونج 10 كجم</td>
                          </tr>
                          <tr>
                            <td style={{ padding: '5px 0', fontWeight: 'bold' }}>السبب:</td>
                            <td>محتوى غير لائق أو تضليل</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <table width="100%" cellPadding={0} cellSpacing={0}>
                      <tbody><tr><td align="center">
                        <a href="#" style={{ display: 'inline-block', background: '#c2410c', color: '#fff', textDecoration: 'none', padding: '14px 40px', borderRadius: 10, fontSize: 16, fontWeight: 'bold' }}>
                          {content.buttonLabel}
                        </a>
                      </td></tr></tbody>
                    </table>
