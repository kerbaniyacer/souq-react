...
export default function AppealDecisionEmail() {
  const content = useEmailContent('appeal-decision');

  return (
    <EmailPreviewWrapper title={content.subject} type="appeal-decision">
                ...
                <tr>
                  <td style={{ padding: '48px 40px' }}>
                     <div style={{ textAlign: 'center', marginBottom: 24 }}>
                        <div style={{ width: 80, height: 80, background: '#f0fdf4', borderRadius: 50, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
                     ...
                     <div style={{ background: '#f8f6f2', borderRadius: 12, padding: 24, margin: '24px 0', border: '1px solid #e8e3db' }}>
                        <p style={{ margin: '0 0 8px', color: '#1f2937', fontWeight: 700 }}>قرار الإدارة:</p>
