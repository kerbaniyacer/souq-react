...
export default function VerifyEmailTemplate() {
  const content = useEmailContent('verify-email');

  return (
    <EmailPreviewWrapper title={content.subject} type="verify-email">
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ padding: '20px 40px 40px' }}>
                    ...
                    <div style={{ background: '#F8FAFC', border: '1px dashed #CBD5E1', borderRadius: 10, padding: '20px', marginBottom: 25 }}>
                      <p style={{ margin: 0, color: '#475569', fontSize: 13, lineHeight: 1.6, textAlign: 'center' }}>
                        {content.bodyText}
                      </p>
                    </div>
                    <table width="100%" cellPadding={0} cellSpacing={0}>
                      <tbody><tr><td align="center">
                        <a href={SITE + '/verify-email?token=example&uid=example'} style={{ display: 'inline-block', background: '#5C8A6E', color: '#fff', textDecoration: 'none', padding: '14px 40px', borderRadius: 10, fontSize: 16, fontWeight: 'bold' }}>
                          {content.buttonLabel}
                        </a>
                      </td></tr></tbody>
                    </table>
