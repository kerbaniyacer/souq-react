                ...
                <tr>
                  <td style={{ padding: '20px 40px 40px' }}>
                    ...
                    <table width="100%" cellPadding={0} cellSpacing={0}>
                      <tbody><tr><td align="center">
                        <a href={`${SITE}/merchant/orders`} style={{ display: 'inline-block', background: '#5C8A6E', color: '#fff', textDecoration: 'none', padding: '14px 40px', borderRadius: 10, fontSize: 16, fontWeight: 'bold' }}>
                          التوجه إلى الطلبات
                        </a>
                      </td></tr></tbody>
                    </table>
